...
class _SignupScreenState extends State<SignupScreen>
  ...
  Future<void> _signup() async {
    ...
    final error = await auth.signup(
      ...
      _idController.text,
      '${_emailController.text.trim()}@kiit.ac.in',
    ...
    if (error == null) {
      // Success: AuthService already marks as logged in, navigate to MainShell
              ...
              child: SlideTransition(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            // Student ID
                            _buildLabel('Roll Number / Student ID', isDark),
                            const SizedBox(height: 8),
                            TextFormField(
                            ...
                            TextFormField(
                              ...
                              validator: (v) {
                                if (v == null || v.trim().isEmpty) {
                                  return 'Enter your KIIT email prefix';
                                }
                                return null;
                              },
                            ),
                    ...
                    // Footer note
                    Text(
                      'Campus Pay is exclusive to\nKIIT authorized college students.',
